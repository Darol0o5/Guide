# Nero ZUNKIES49 (NZ_49)



![Nero](nz494.jpg){ width="500" }
...
- **Developed by:** *Nockizz Ardian Troy*
...
- **Servo position:** ❌(not independently)

- **Pinion-Spur distance:** ❌

- **Front knuckle KPI hinge point:** ❌ (not confirmed)
...
- **Wheelbase range:** *94–98 mm(90-100 mm later and custom options)*

- **Track width range:** *xx–yy mm*

- **Caster adjustment:** *spacers*

- **Ackermann adjustment:** *adjusted by steering links*
