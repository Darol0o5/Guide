...
![ADS Sleipnir III](sleipnir-iii.jpg){ width="500" }
...
- **Developed by:** *Advanced Development System(Al Kautsar Kilimanjaro)*
...
- **Materials:** *PLA, carbon fiber version(lower deck, upper deck, motor mount)*
...
- **Motor position:** mid ✅(FD) / high ✅(Pro) / rear ✅
...
- **Front:** *double wishbone, independent, cantilever(push rod) 2 shocks*
