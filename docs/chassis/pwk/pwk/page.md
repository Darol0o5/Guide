...
- **Wheelbase adjustment method:** *fixed*

- **Wheelbase range:** *94mm(not confirmed)*

- **Track width range:** *??–?? mm*

- **Caster adjustment:** *fixed*
...
- **Steering method:** *direct* (vertical servo position)
...
<div class="chassis-rating" data-slug="pwk"></div>
